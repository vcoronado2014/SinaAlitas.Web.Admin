<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TareasProfesor.aspx.cs" Inherits="TareasProfesor" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CerrarClase(nombreCliente, id) {
            ...
            popupCerrarClase.SetHeaderText("Cerrar Clase");
            popupCerrarClase.SetContentUrl(url);
            popupCerrarClase.Show();
        }
        function MostrarFicha(pcoId) {
            var url = "detalleAlumnos.aspx?PCO_ID=" + pcoId;
            popupCerrarClase.SetHeaderText("Ficha Alumnos");
            popupCerrarClase.SetContentUrl(url);
            popupCerrarClase.Show();
        }
        function CancelarClase(nombreCliente, id) {
            ...
            if (retVal == true) {
                popupCerrarClase.SetHeaderText("Cancelar Clase");
        ...
        <div class="container" style="padding-left:0; padding-right:0;">
            ...
            <nav class="navbar navbar-principal-profe navbar-fixed-bottom">
                <div class="col-xs-12 container-footer">
                    ...
                    <div id="iconoMedicamentos" class="col-xs-2 glyphicon glyphicon-tasks font-nav-bar active-navbar-profe height-50 text-center cursor-pointer" aria-hidden="true">
                                        ...
                                        <asp:Repeater ID="rptItems" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <div class="col-xs-12 no-padding">
                                                    ...
                                                    <i class="fa fa-phone"></i>&nbsp;<span class="font-pequeno"><%# Eval("TelefonoCliente", "{0}")%></span><br />
                                                    <%--<i class="fa fa-map"></i>&nbsp;<dx:ASPxHyperLink ID="hlDireccion" runat="server" Text='<%# Eval("DireccionCliente", "{0}")%>' NavigateUrl='<%# String.Format("visorDirecciones.aspx?DIRECCION_CONSULTAR={0}", DataBinder.Eval(Container.DataItem, "DireccionCliente")) %>' Target="_blank">
                                                    </dx:ASPxHyperLink>--%>
                                                    <div class="col_xs_12" onclick="AbrirUrl('<%# String.Format("visorDirecciones.aspx?DIRECCION_CONSULTAR={0}", DataBinder.Eval(Container.DataItem, "DireccionCliente")) %>')">
                                                    <i class="fa fa-map"></i>&nbsp;<a href="#"><%# Eval("DireccionCliente", "{0}")%></a>
                                                        </div>
                                                </div>
                                                    <div class="col-xs-4 text-center">
                                                        <div class="col-xs-12 text-center no-padding">
                                                            <i class='<%# Eval("ClaseVisible", "{0}")%>' onclick="CerrarClase('<%# Eval("NombreCliente", "{0}")%>', '<%# Eval("Id", "{0}")%>')">
                                                                <div class="col-xs-12 text-center font-muypequeno no-padding">
                                                                    <span style="font-size: 10pt; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Cerrar Clase</span>
                                                                </div>
                                                            </i>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-4 text-center">
                                                        <div class="col-xs-12 text-center no-padding"  onclick="MostrarFicha('<%# Eval("PcoId", "{0}")%>')">
                                                            <i class="fa fa-2x fa-users">
                                                                <div class="col-xs-12 text-center font-muypequeno no-padding">
                                                                    <span style="font-size: 10pt; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Mostrar Ficha</span>
                                                                </div>
                                                            </i>
                                                        </div>
                                                    </div>
