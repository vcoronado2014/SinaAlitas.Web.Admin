<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cerrarclase.aspx.cs" Inherits="cerrarclase" %>
            ...
            <li class="left clearfix">
                ...
                <div class="chat-body clearfix">
                    <p class="text-justify" style="padding-right:15px;">
                        Estimado Profesor, en este apartado usted podrá cerrar la clase que ha realizado a <asp:Literal ID="litNombre" runat="server"></asp:Literal> y si lo desea puede escribir alguna observación al respecto.
                    </p>
            ...
            <PanelCollection>
                <dx:PanelContent runat="server">
                    ...
                    <div class="col-xs-12 col-md-6 pull-right">
                        ...
                        <dx:ASPxButton ID="btnGuardar" runat="server" Text="Cerrar Clase" Width="100%" Native="true" CssClass="btn btn-primary" AutoPostBack="False">
